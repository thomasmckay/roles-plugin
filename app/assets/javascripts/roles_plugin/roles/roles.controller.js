...
/**
 * @ngdoc object
 * @name  RolesPlugin.roles.controller:RolesController
 *
 * @requires $scope
 * @requires $location
 * @requires Nutupane
 ...
 *
 * @description
 *   Provides the functionality specific to RolesPlugin for use with the Nutupane UI pattern.
 *   Defines the columns to display and the transform function for how to generate each row
 *   within the table.
 */
angular.module('RolesPlugin.roles').controller('RolesController',
