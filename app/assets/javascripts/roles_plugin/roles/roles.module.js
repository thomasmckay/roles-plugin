...
/**
 * @ngdoc module
 * @name  RolesPlugin.roles
 *
 * @description
 *   Module for roles
 */
angular.module('RolesPlugin.roles', [
    'ngResource',
    'ui.router',
    'Bastion',
 ...
 */
angular.module('RolesPlugin.roles').config(['$stateProvider', function ($stateProvider) {
