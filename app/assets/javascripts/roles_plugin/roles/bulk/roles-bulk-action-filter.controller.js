...
/**
 * @ngdoc object
 * @name  RolesPlugin.roles.controller:RolesBulkActionEnvironmentController
 *
 * @requires $scope
 * @requires Role
 ...
 */
angular.module('RolesPlugin.roles').controller('RolesBulkActionEnvironmentController',
